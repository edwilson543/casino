    ...
    def roulette_loop(self):
        ...
        while True:
            ...
            if self.navigation_id in navigation_dict['from_bet_choice']:
                ...
                bet_placer = BetPlacementUser(bet_type_id=self.active_bet_type_id, wheel_id=self.active_wheel_id,
                ...
                bet_placer.set_bet_type_wheel()  # makes sure the bet_placer knows the active wheel, from id
                self.active_bet_choice = bet_placer.get_user_bet_choice()
                self.active_winning_slots = bet_placer.get_win_criteria(self.active_bet_choice)
                self.active_potential_winnings = bet_placer.get_potential_winnings()
