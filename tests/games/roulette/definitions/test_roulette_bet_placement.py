...
class TestBetPlacementColours:
    def test_determine_win_criteria_red(self):
        ...
        test_colours_bet = ColoursBet(bet_choice='red', playing_wheel=EuroWheel())  # test for colour red
    ...
    def test_determine_win_criteria_bias_colour(self):
        ...
        test_colours_bet = ColoursBet(bet_choice='green', playing_wheel=EuroWheel())
        with pytest.raises(ValueError):
            test_colours_bet.determine_win_criteria()  # test for co
    ...
    def test_determine_win_criteria_invalid_colour(self):
        ...
        test_colours_bet = ColoursBet(bet_choice='orange', playing_wheel=EuroWheel())
        with pytest.raises(ValueError):
...
class TestBetPlacementStraightUp:
    def test_determine_win_criteria_valid_slot(self):
        ...
        test_straight_up_bet = StraightUpBet(bet_choice=1, playing_wheel=EuroWheel())  # test for slot 1
    ...
    def test_determine_win_criteria_invalid_slot(self):
        ...
        test_straight_up_bet = StraightUpBet(bet_choice=100, playing_wheel=EuroWheel())
        with pytest.raises(ValueError):
